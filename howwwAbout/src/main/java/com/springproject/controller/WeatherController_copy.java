...
import com.springproject.domain.Weather;

//@Controller
//@RequestMapping("/weather")
public class WeatherController_copy 
{
	@GetMapping("/call")
	public Weather apicall()
	{
...
//	        }
	        ...
	        for(int i=0; i<item.length(); i++)
	        {
	        	...
	        	{
	        		System.out.println("기온 찾음");
	        		weather.setT1H(item.getJSONObject(i).getString("fcstValue"));
	        	}
	        	if(category.equals("SKY"))
	        	{
	        		System.out.println("하늘상태 찾음");
	        		weather.setT1H(item.getJSONObject(i).getString("fcstValue"));
	        	}
	        }
		} 
