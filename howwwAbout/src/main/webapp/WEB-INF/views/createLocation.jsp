...
<form:form modelAttribute="location" method="post">
	...
	<p>위도 : <form:input path="lattitude" name="lattitude" /> </p>
	<p>경도 : <form:input path="logitude" name="logitude" /> </p>
	...
	<p>이미지 주소 2 : <form:input path="fileurl3" name="fileurl3" /> </p>
	<p>이미지 주소 3 : <form:input path="fileurl4" name="fileurl4" /> </p>
	<p>이미지 주소 4 : <form:input path="fileurl5" name="fileurl5" /> </p>
