...
<form:form modelAttribute="location" method="post">
	<p>장소명 : <form:input path="data_title" name="data_title" required /> </p>
	<p>주소 : <form:input path="user_address" name="user_address" required/> </p>
	<p>위도 : <form:input path="latitude" name="latitude" /> </p>
	<p>경도 : <form:input path="longitude" name="longitude" /> </p>
	<p>담당기관 : <form:input path="insttnm" name="insttnm" required/> </p>
	<p>카테고리 구분 (ex.바다) : 
		<form:input path="category_name1" name="category_name1" required/> 
