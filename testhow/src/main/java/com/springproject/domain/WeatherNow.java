...
public class WeatherNow {
	...
	private String fcstDate; //예측 일자 -- 이 날짜에
	private String fcstTime;//예보 시각 --이 시간에 날씨
	private String fcstValue;//예보 값
	private String nx; //예보지점 X좌표
	private String ny; //예보지점 Y좌표
	public WeatherNow(String base_date, String base_time, String category, String fcstDate, String fcstTime,
