...
//@Repository
public class WeatherCallDay_copy {
    ...
    public List<WeatherDayByDate> getWeatherByDate(){
    	...
    	for(int i = 0; i <weatherDayList.size(); i++) {
    		...
    		String category = weatherDay.getCategory();
    		String fcstValue = weatherDay.getFcstValue();
    		String fcstDate = weatherDay.getFcstDate();
    		String fcstTime = weatherDay.getFcstTime();
    		String nx=weatherDay.getNx();
